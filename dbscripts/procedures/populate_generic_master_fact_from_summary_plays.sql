...
CREATE PROCEDURE populate_generic_master_fact_from_summary_plays()
BEGIN
...
REPEAT
  ...
  IF NOT done THEN
	...
	null as `parent_account_id`
      FROM
          t5m_stats.summary_plays_daily_device spdd
INNER JOIN
    v3.playlists_0
ON
    spdd.vid = playlists_0.id
